ExpirationLocals = {
	...
	["/expiration location <console/frame/raid/party/guild/officer> - Default location to send reports."] = "/expiration location <console/frame/raid/party/guild/officer> - Default location to send reports.",
